...
class generarReporte extends FPDF{
  ...
  //    $this->SetTextColor(23, 162, 184);
    ...
    public function body(){
      ...
      $reporteTerminados = ControladorGeneral::ctrreporteTerminadospdf($idPedido);
      ...
      $this->Cell(35,10, 'Cantidad Solicitada', 0, 0, 'C', 1);
    //  $this->Cell(40,10, 'Cantidad Prevista', 0, 0, 'C', 1);
      ...
      foreach ($reporteTerminados as $key => $value) {
       ...
       // $cantidadPrevista = $this->carcularCantidad($minTrancurridos, $value["porMin"]);
        ...
        $this->Cell(35,10, $value["cantidadSolicitada"], 'B', 0, 'C', 1);
