        ...
        <div class="card-body">
            <div class="table-responsive">
              <table class="table  table-bordered table-striped   tablas " >
                ...
                $item = null;
                $valor = null;
                $respuesta = ControladorAsignar::cntMostrarMostrarPrimerModulo($item , $valor);
                foreach ($respuesta as $key => $value) {
                    echo '<tr>
                            ...
                            <td>';
                                if($value["estado"] == '1'){
                                    echo '<label for="" class="btn btn-success">Asignado</label>';
                                }else{
                                  echo '<label for="" class="btn btn-danger">No Asignado</label>';
                                }
                            echo '</td>
                            <td>
                                <div class="btn-group">
