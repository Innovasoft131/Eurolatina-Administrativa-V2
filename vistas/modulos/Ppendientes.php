            ...
            <div class="table-responsive">
              <table class="table  table-bordered table-striped   tablas " >
                ...
                <?php
                  ...
                  $respuesta = ControladorPresupuesto::ctrMostrarPresupuestosProceso($item, $valor);
                  ...
                  echo '<tr>
                          ...
                          <td>'.$value["codigo"].'</td>
                          <td>'.$value["cliente"].'</td>
                          <td>'.$value["importePresupuesto"].'</td>
                          <td>'.$value["estado"].'</td>
                          <td>'.$value["accion"].'</td>
                          <td>'.$value["fecha"].'</td>
                          <td>
                            <button class="btn btn-secondary btnVer" idOportunidad="'.$value["id"].'"><i class="fas fa-eye"></i></button>
                            <button class="btn btn-danger btnEliminar" idOportunidad="'.$value["id"].'" style="background: rgb(255 136 2); border: 0px solid ;"><i class="fas fa-times"></i></button> 
                          </td>
...
<?php
  ...
  $borrarPresupuesto -> ctrBorrarPresupuesto();
